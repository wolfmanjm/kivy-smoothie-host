...
# we must have Python version between 3.7.3 and 3.13.x
assert (3, 13, 99) >= sys.version_info >= (3, 7, 3), f"Python version needs to be >= 3.7.3 and <= 3.13.x, you have {sys.version}"
