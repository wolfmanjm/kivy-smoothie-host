...
This uses python >= 3.5 and < 3.9 and Kivy 2.x.x
...
It will run on Windows if you install Python 3.6, and follow the kivy instructions for installing kivy on windows. https://kivy.org/doc/stable/installation/installation-windows.html

NOTE it is untested on python versions >= 3.9 but may work.
