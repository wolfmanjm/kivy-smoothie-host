...
The ```=1/2``` button will move the currently selected axis to half the current WCS. (ie if WCS is set to 0,0 at front left and spnidle is at right edge it would move to the middle in X)
